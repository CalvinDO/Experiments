...
public class Main {
	...
	public static JButton showPUN;
	public static JButton showPUCombination;
	...
	private static void CreateFrame(ApplicationTime thread) {
		...
		showPUN = new JButton("Show PUN");
		styleSecondaryButton(showPUN, secondaryWidth, secondaryHeight, secondaryFontSize, mainPanel);
		...
		showPUCombination = new JButton("Show PU ");
		styleSecondaryButton(showPUCombination, secondaryWidth, secondaryHeight, secondaryFontSize, mainPanel);
...
class YourGraphicsContent extends JPanel implements ActionListener {
	...
	public static boolean showPUCombination = true;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == Main.showPUN) {
			if (showPUNVisualization) {
				showPUNVisualization = false;
				Main.showPUN.setText("show PUN");

			} else {
				showPUNVisualization = true;
				Main.showPUN.setText("hide PUN");
			}
		}

		if (e.getSource() == Main.showPUCombination) {
			if (showPUCombination) {
				showPUCombination = false;
				Main.showPUCombination.setText("show PU");
			} else {
				showPUCombination = true;

				Main.showPUCombination.setText("hide PU");
			}
		}
