...
(function (Matrix) {
    ...
    class Matrix4D {
        ...
        equals(matrix, threshold = this.epsilon) {
            for (let i = 0; i < 16; i++) {
        ...
        static lookAt(position, target, up = Vector3D.up) {
    ...
    Matrix4D.identity = new Matrix4D().setIdentity();
